...
(define tests
  (test-suite
   ...
   (check-equal? (eval-exp (call (closure '() (fun "foo" "x" (ifgreater (var "x") (int 0) (call (var "foo") (int 0)) (int 0)))) (int 1))) (int 0) "call test recursive")
   ...
   (check-equal? (eval-exp (mlet* (list (cons "x" (int 10)) (cons "y" (add (var "x") (int 1)))) (var "y"))) (int 11) "mlet* test 2")
